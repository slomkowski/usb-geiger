 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', ' ', 'G', 'e', 'i', 'g', 'e', 'r'
...
// this configuration is valid for D+ connected to PA7 and firing Pin-change interrupt 0
#define USB_INTR_CFG            GIMSK
#define USB_INTR_CFG_SET        (1 << PCIE0)
//#define USB_INTR_CFG_CLR        0
#define USB_INTR_ENABLE         PCMSK0
#define USB_INTR_ENABLE_BIT     PCINT7
